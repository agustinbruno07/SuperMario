...
public class dialogos extends JPanel {
    ...
    private String textoCompleto = "¡¿Qué pasa loco, por qué me llaman en mi día libre?!";
    ...
    public dialogos(JFrame frame) {
        ...
        Musica.reproducirLoop("src/resources/sonidos/birdSound.wav");
    ...
    private void avanzarAlJuego() {
        ...
        parentFrame.getContentPane().add(new Objetos(parentFrame));
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (imagenDialogo != null) {
            ...
            if (textoCompletado) {
                ...
                String texto = "Presiona ESPACIO o haz CLIC para continuar";
